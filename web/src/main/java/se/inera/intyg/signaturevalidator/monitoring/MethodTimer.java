 ...
 */
@Aspect("pertarget(se.inera.intyg.signaturevalidator.monitoring.MethodTimer.timeable())")
@Scope("prototype")
@ControllerAdvice
public class MethodTimer {
    ...
    @Pointcut("@annotation(se.inera.intyg.signaturevalidator.monitoring.PrometheusTimeMethod)")
