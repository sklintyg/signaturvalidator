...
import se.inera.intyg.signaturevalidator.web.responder.InternalPingForConfigurationResponderImpl;

@Configuration
@ComponentScan({
        "se.inera.intyg.signaturevalidator.service",
        "se.inera.intyg.signaturevalidator.web"})
